  ...
  return (
    <div className=" bg-slate-50 ">
      ...
      <div className=" sm:flex flex flex-col sm:flex-row sm:mb-8 items-center sm:gap-6 lg:gap-64">
        <div className=" bg-white px-5 mt-10  py-6 text-center rounded-lg sm:ml-36 border border-slate-300 w-[260px] sm:w-[350px]  sm:h-[400px] ">
        ...
        <div className=" text-7xl p-3   ">
          ...
          <div className=" flex flex-col mb-10">
            <Link to={"/student"} className=" mt-12 text-lg text-blue-600 font-semibold">
              <h1 className=" hover:bg-blue-500  hover:text-white border rounded-md border-blue-600 p-1.5 px-4">My Courses  <DoubleArrowIcon className=" ml-14"/></h1>
              
              
            </Link>
            <Link className=" mt-12 text-lg text-blue-600 font-semibold">
              <h1 className=" hover:bg-blue-500 hover:text-white border rounded-md border-blue-600 p-1.5 px-4">Change Password <DoubleArrowIcon className=" ml-3"/></h1>
            </Link>
          </div>
        </div>
      </div>
