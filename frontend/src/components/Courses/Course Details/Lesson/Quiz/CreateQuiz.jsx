...
const CreateQuiz = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      await axios.post("/api/quiz/create", { lessonId, questions });
      ...
      <div> 
        ...
        <div className="z-10 bg-white shadow-md rounded-lg p-4 m-14 mt-6 space-y-4">
          <form onSubmit={handleSubmit} className=" flex flex-col p-10 px-40  space-y-4">
            ...
            <button type="submit" className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline btn btn-success self-end">
              Create Quiz
            </button>
          </form>
          ...
          <Link><h1>Skip <NavigateNextIcon /></h1></Link> 
