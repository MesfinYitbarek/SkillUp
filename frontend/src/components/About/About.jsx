  ...
  return (
    <div className="dark:text-white dark:bg-gray-800">
      ...
      <motion.div
        ...
        className="relative h-[40vh] md:h-[50vh] flex items-center justify-center text-white"
        style={{
      ...
      <div className="dark:bg-gray-800 dark:text-white bg-slate-50 flex flex-col gap-20">
        ...
        <div className="px-6 md:px-14 lg:px-20 flex flex-col md:flex-row gap-12 md:gap-24 justify-between items-center py-12 md:py-20">
          <div className="md:w-1/2">
            <h1 className="text-red-400 font-bold mb-4">How It Started</h1>
            <h5
              data-aos="zoom-in"
              data-aos-once="true"
              className="mb-5 font-semibold text-3xl md:text-5xl text-blue-800"
            >
          ...
          <div className="md:w-1/2 mt-8 md:mt-0">
            <div className="bg-blue-100 rounded-lg p-4 md:p-8 shadow-lg">
              <img
        ...
        {/* Our Story Section */}
        <div className="flex flex-col text-white items-center bg-blue-800 p-6 md:p-8 py-12 md:py-16">
          <h2 className="text-center font-semibold mb-8 md:mb-10 text-3xl md:text-4xl">OUR STORY</h2>
          <hr data-aos="fade-right" className="bg-white h-1 w-[60%] md:w-[20%] mb-8 md:mb-10" />
          <p className="text-center text-base md:text-lg max-w-3xl leading-relaxed px-4">
        ...
        {/* Our Mission Section */}
        <div className="flex flex-col items-center mx-6 md:mx-10 dark:text-white text-slate-900 p-6 md:p-8 py-12 md:py-20">
          <h2 className="font-semibold mb-5 text-3xl md:text-4xl">OUR MISSION</h2>
          <hr data-aos="fade-right" className="bg-blue-800 h-1 w-[60%] md:w-[20%] mb-8 md:mb-10" />
          <div className="border-4 border-blue-800 p-6 md:p-8 py-12 md:py-20 text-center max-w-4xl rounded-lg shadow-lg">
        ...
        <div className="mx-6 md:mx-14 lg:mx-20 my-12 md:my-20 flex flex-col">
          <h2 className="dark:text-white text-3xl md:text-4xl font-bold text-blue-800 mb-8 md:mb-10 text-center">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
            {unique.map((data) => (
              <div
                key={data.id}
                className="group dark:text-white dark:bg-gray-600 text-blue-800 hover:scale-105 transition-all duration-300 flex flex-col text-center items-center pt-7 bg-white hover:bg-gradient-to-r from-purple-500 to-blue-500 hover:text-white shadow-lg p-4 md:p-6 rounded-lg"
              >
                <div className="text-4xl md:text-5xl mb-4">{data.icon}</div>
                <h2 className="text-center mb-2 font-bold text-lg md:text-xl">
                  {data.title}
                </h2>
                <hr
                  data-aos="fade-left"
                ...
                />
                <p className="font-semibold p-1 rounded-md text-sm md:text-base">
                  {data.description}
                </p>
              </div>
            ))}
        ...
        <div className="dark:bg-gray-700 bg-slate-300 px-6 md:px-10 lg:px-20 py-12 md:py-16">
          <h2 className="mb-5 dark:text-white text-2xl md:text-3xl font-bold text-blue-800 text-center">
            Join the SkillUp Community
          </h2>
          <p className="text-center text-base md:text-lg mb-8 md:mb-10">
        ...
        {/* Closing Statement */}
        <div className="dark:text-white px-6 md:px-10 lg:px-20 text-xl md:text-4xl py-6 text-blue-800 pb-12 font-bold text-center">
